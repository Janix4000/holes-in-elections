...
def main():
    ...
    parser.add_argument("--num_voters", type=int, default=60)
    parser.add_argument("--num_instances", type=int, default=7*7)
    parser.add_argument("--num_new_instances", type=int, default=8)
